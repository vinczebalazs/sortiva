...
export default {
  name: 'raw googleapis import outside the Search Console wrapper (invariant 25)',
  file: 'packages/core/src/__lintproof__/raw-googleapis-import.ts',
  source: [
    "import { google } from 'googleapis'",
    '',
    'export const search = google',
    '',
  ].join('\n'),
