...
const NAMED_THRESHOLDS: ReadonlyArray<readonly [path: string, spec: string]> = [
  ...
  ['signals.product_family_coverage_gap.revenue_share_min', 'main §7.3 — ≥ 10% of trailing-window revenue'],
  ['signals.product_family_coverage_gap.revenue_window_days', 'main §7.3 — trailing-window revenue (60d; Shopify gives no more)'],
