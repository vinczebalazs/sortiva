...
- **A product attribute** — anything saying what one of these products *is*,
  what it is made of, or how it is built, with or without a number in it.
  "Built on a wider last", "double-walled", "hand-finished", "the handle is
  most of the weight". A product's **name is not a fact about it**: a shoe
  called Wide tells you what the merchant called it, never how it is shaped.
...
**Explaining how a kind of thing works is not a claim about a product, and
needs no citation.** "Wider lasts suit wide feet" is knowledge about footwear;
"glass breaks on a hard floor and steel dents instead" is knowledge about
materials. Write those freely — they are most of what makes an article worth
reading rather than a list of specifications, and no claim will ever be
offered for them because a store holds no facts about the world at large.

**A figure is the exception.** A number, a measurement, a percentage or a
duration needs an approved claim behind it wherever it appears, general
statement or not. If you cannot cite the figure, make the point without it.

The line falls where such a statement is attached to one of these products.
Then the attribute it rests on has to come from an approved claim: if a claim
records a bottle as single-wall plastic you may say it will not keep a drink
cold, and you may not call any bottle double-walled unless a claim says it is.
